...
export default function SehatStationBusinessContactForm() {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-8 max-w-2xl mx-auto mb-5 mt-36">
      <h2 className="text-2xl font-bold mb-2 text-gray-800">
        Contact SehatStation for Business
      </h2>
      <p className="text-gray-600 mb-6">
        Interested in our healthcare management solutions? Let's connect!
      </p>
          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={solution} className="flex items-center">
                    <input
                      type="checkbox"
                      id={solution.replace(/\s+/g, "")}
                      name="solutions"
                      value={solution}
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label
                      htmlFor={solution.replace(/\s+/g, "")}
            ...
            <div className="flex items-center">
              ...
              <label
                ...
                className="ml-2 block text-sm text-gray-900"
              >
                I agree to be contacted about SehatStation solutions
              </label>
            </div>
