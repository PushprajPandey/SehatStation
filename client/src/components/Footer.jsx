...
const Footer = () => {
  ...
  const handleSubscribe = async () => {
    try {
      const response = await fetch(
        "http://localhost:8080/otherroutes/subscribe",
        {
          method: "POST",
          headers: {
  ...
  const socialMedia = [
    {
      Icon: FaGithub,
      link: "https://github.com/PushprajPandey",
      color: "#333",
    },
    {
      Icon: FaInstagram,
      link: "https://www.instagram.com/pushpandey04",
      color: "#7289DA",
    },
    // { Icon: FaXTwitter, link: 'https://twitter.com', color: '#1DA1F2' },
    {
      Icon: FaLinkedinIn,
      link: "https://www.linkedin.com/in/pushpraj-pandey-249732250",
      color: "#0077B5",
    },
  ];
  ...
  const contactUsLinks = [
    ...
    // Support Us, Customer Care not implemented, so keep commented
  ];
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="text-center md:col-span-2 lg:col-span-4 my-4">
          ...
          {message && (
            <p
              className={`text-2xl mt-2 ${messageType === "success" ? "text-green-500" : "text-red-500"}`}
            >
              {message}
            </p>
          )}
        ...
        <div className="flex flex-wrap justify-between space-x-4">
          ...
          <div className="space-y-4 w-full md:w-auto">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              The SehatStation platform simplifies hospital management with
        ...
        <div className="mt-8 pt-8 border-t border-[#b6dbfc]/30 text-center">
          ...
          >
            "The information provided on SehatStation is intended for general
            ...
            treatment. SehatStation facilitates OPD appointment booking and
