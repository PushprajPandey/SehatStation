    ...
    <>
      ...
      <div className="mt-14">
        ...
        <Routes>
          ...
          <Route exact path="/about-hospital" element={<AboutHospital />} />
          <Route exact path="/about-doctor" element={<AboutDoctor />} />
          <Route
            exact
            path="/opd-registration"
            element={<OPDRegistrationForm />}
          />
      ...
      {!showNavAndFooter && (
        ...
        <div className="fixed bottom-4 right-6 flex flex-col gap-3"></div>
      )}
    </>
  );
}
