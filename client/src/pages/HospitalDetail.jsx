// No changes needed here. 'Running Appointments' and 'Book AppointmentMore Details' are not rendered in this detail page. If you want to remove them from the hospital list, please specify the relevant file (e.g., HospitalList.jsx or a card component).
